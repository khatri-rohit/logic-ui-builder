...
export default function Home() {
  return (
    <div data-logic-root className={`logic-root ${terminalFont.variable}`}>
      <LandingHeader />

      <main className="space-y-0 pt-24">
        <section className="hero-section min-h-screen border-b border-(--logic-border) flex items-center justify-center">
              ...
              <div className="w-full max-w-2xl border border-black bg-(--logic-bg) shadow-[20px_20px_0px_0px_rgba(0,0,0,0.05)]">
                ...
                <div className="grid grid-cols-3 gap-4 p-8">
                  ...
                  <div className="stagger-card col-span-2 -translate-y-8 translate-x-12 scale-95 border border-(--logic-border) bg-white p-6">
                    ...
                    <div className="line-sweep mt-2 h-1 w-3/4 bg-[var(--logic-border)]" />
                    <div className="line-sweep mt-2 h-1 w-1/2 bg-[var(--logic-border)]" />
                  </div>
                  <div className="stagger-card flex h-32 items-center justify-center border border-black bg-[var(--logic-surface-subtle)] p-4">
        ...
        <section className="border-b border-[color:var(--logic-border)] bg-[var(--logic-bg)]">
          <div className="grid grid-cols-1 divide-x divide-[var(--logic-border)] md:grid-cols-2">
            <div className="scroll-item space-y-8 p-12">
              ...
              <div className="relative aspect-video overflow-hidden border border-[color:var(--logic-border)] bg-white">
                <Image
                  fill
              ...
              <div className="grid grid-cols-3 gap-1">
                <div className="mono border border-[color:var(--logic-border)] p-4 text-xs text-[var(--logic-muted)]">
            ...
            <div className="scroll-item space-y-8 bg-[var(--logic-surface-muted)] p-12">
              <div className="flex items-start justify-between">
              ...
              <div className="mono flex items-center justify-between border border-[color:var(--logic-border)] bg-white p-4 text-xs text-black">
        ...
        <section className="grid grid-cols-1 gap-8 border-b border-[color:var(--logic-border)] bg-[var(--logic-surface-subtle)] p-12 md:grid-cols-12">
          <div className="scroll-item space-y-4 md:col-span-8">
            <div className="mono text-xs uppercase tracking-[0.2em] text-[var(--logic-muted)]">
          ...
          <div className="scroll-item flex h-64 flex-col justify-between border border-black bg-white p-8 md:col-span-6">
            <div>
              <span className="mono text-xs text-[var(--logic-muted)]">
                NEURAL_CORE_01
              </span>
            ...
            <div className="space-y-2">
              ...
              <div className="h-2 bg-[var(--logic-surface-subtle)]">
                <div className="line-fill h-full w-[95%] bg-black" />
              </div>
            </div>
          </div>

          <div className="scroll-item flex h-64 flex-col justify-between border border-[color:var(--logic-border)] bg-[var(--logic-bg)] p-8 md:col-span-6">
            <div>
              <span className="mono text-xs text-[var(--logic-muted)]">
                DEPTH_ENGINE_02
              </span>
            ...
            <div className="space-y-2">
              ...
              <div className="h-2 bg-[var(--logic-surface-subtle)]">
                <div className="line-fill h-full w-[84%] bg-[var(--logic-border)]" />
              </div>
            </div>
          </div>

          <div className="scroll-item h-80 overflow-hidden border border-[color:var(--logic-border)] bg-black p-8 text-white md:col-span-4">
          ...
          <div className="scroll-item grid-bg relative h-80 border border-[color:var(--logic-border)] bg-white p-12 md:col-span-8">
      ...
      <style jsx>{`
        .logic-root {
          --logic-bg: #f9f9f9;
          --logic-surface-muted: #f4f3f3;
          --logic-surface-subtle: #eeeeee;
          --logic-border: #c6c6c6;
          --logic-border-soft: #eeeeee;
          --logic-muted: #777777;
        ...
        .logic-root .grid-bg {
          background-image:
            linear-gradient(var(--logic-surface-subtle) 1px, transparent 1px),
            linear-gradient(
              90deg,
              var(--logic-surface-subtle) 1px,
              transparent 1px
            );
